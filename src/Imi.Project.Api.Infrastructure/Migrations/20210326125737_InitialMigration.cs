    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-400000000000"), false, "Abigail Spencer" },
                    { new Guid("00000000-0000-0000-0000-100000000000"), false, "Bjorn Vossen" },
                    { new Guid("00000000-0000-0000-0000-200000000000"), false, "Sofie Brauwers" },
                    { new Guid("00000000-0000-0000-0000-300000000000"), false, "Athena Faris" },
                    { new Guid("00000000-0000-0000-0000-500000000000"), false, "Kaley Cuoco" }
                });
